...
Route::post('product/add/{id}','ProductController@addStock')->middleware('auth:api');
Route::post('product/remove/{id}','ProductController@removeStock')->middleware('auth:api');
...
Route::get('customer/search','CustomerController@search')->middleware('auth:api');
